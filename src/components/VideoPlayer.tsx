...
import { Play, Pause, Volume2, VolumeX, Settings, Maximize2, Minimize2, Lock, Unlock } from 'lucide-react';
  ...
  return (
    <section className="bg-transparent flex justify-center py-1.5 px-4 select-none">
      <div 
        ...
        className={`w-full max-w-sm sm:max-w-md md:max-w-xl lg:max-w-[640px] bg-slate-950/30 backdrop-blur-md rounded-2xl p-1 shadow-2xl relative border border-slate-800/50 transition-all duration-300 ${
      ...
      >
        ...
        >
          ...
          {url && (
            <div 
              id="viewerBadge" 
              className="absolute top-2.5 left-3 bg-black/70 backdrop-blur-md px-2.5 py-0.5 rounded-full text-xs font-bold text-white flex items-center gap-1.5 border border-white/20 pointer-events-none select-none z-10"
            >
            ...
            <div className="flex items-center gap-2.5 md:gap-3 flex-none relative">
              ...
              <div className="relative">
                ...
                {showQualityMenu && (
                  <div 
                    id="qualityMenu"
                    className="absolute bottom-9 right-0 bg-slate-900/98 backdrop-blur-lg border border-white/20 rounded-xl py-1 min-w-[100px] shadow-2xl flex flex-col z-50 animate-fade-in"
                  >
          ...
          {statusMessage && (
            <div className="absolute bottom-12 inset-x-0 mx-auto max-w-xs text-center bg-black/85 backdrop-blur-md text-white text-xs py-2 px-4 rounded-xl border-l-4 border-white shadow-lg pointer-events-none z-10 select-none">
              {statusMessage}
            </div>
          )}
