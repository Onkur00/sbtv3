...
export const CategoryBar: React.FC<CategoryBarProps> = ({
  ...
  return (
    <nav 
      id="categoryBar" 
      className="bg-slate-950/20 backdrop-blur-md mx-5 my-2 px-5 py-2 rounded-full flex gap-2.5 overflow-x-auto whitespace-nowrap scrollbar-none border border-white/10"
    >
      {categories.map((cat) => {
